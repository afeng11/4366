...
#
# $Id: wps_common_lib.mk 511542 2014-10-30 04:58:39Z $
#
# Linux makefile
#
...
export INCLUDE = -I$(SRCBASE)/include -I$(SRCBASE)/../components/shared -I./include $(WLAN_ComponentIncPathR) $(WLAN_StdIncPathR)
