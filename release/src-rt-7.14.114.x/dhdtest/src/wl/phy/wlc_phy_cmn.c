 ...
 *
 * $Id: wlc_phy_cmn.c 540841 2015-03-13 07:01:38Z $
 */
...
void wlc_phy_rxgainctrl_gainctrl_acphy_tiny(phy_info_t *pi);
...
wlc_phy_scanroam_cache_cal(phy_info_t *pi, bool set)
{
	if (ISHTPHY(pi)) {
		...
		wlc_phy_scanroam_cache_cal_acphy(pi->u.pi_acphy->calmgri, set);
	}
...
{
#ifdef PREASSOC_PWRCTRL
	if ((pi->radio_chanspec != chspec) && ISACPHY(pi) && pi->sh->up) {
...
wlc_phy_chanspec_bandrange_get(phy_info_t *pi, chanspec_t chanspec)
{
	...
	if (ISNPHY(pi)) {
	  ...
	  if (SROMREV(pi->sh->sromrev) < 12) {
	    range = wlc_phy_get_chan_freq_range_acphy(pi, chanspec, PRIMARY_FREQ_SEGMENT);
	  } else {
...
#define HWACI_CLIP_INIT_DESENSE	9
#define HWACI_CLIP_HIGH_DESENSE 9
#define HWACI_CLIP_MED_DESENSE	9
#define HWACI_CLIP_LO_DESENSE	9
#endif /* WL_ACI_FCBS */
...
#ifndef WL_ACI_FCBS
		phy_info_acphy_t *pi_ac = pi->u.pi_acphy;
		pi_ac->hw_aci_status = wlapi_bmac_read_shm(pi->sh->physhim, M_HWACI_ST) & 1;
...
{
	phy_info_t *pi = (phy_info_t *)ppi;
	wlc_acphy_print_phydbg_regs(pi);
}
#endif /* DNG_DBGDUMP */
int
	...
	uint8 tmp_max_pwr, ppr_t *tx_srom_max_pwr)
{
	...
	if (CHSPEC_IS40(chanspec)) {
		if (NPHY_IS_SROM_REINTERPRET) {
			...
			tmp_mcs_word =
				(pi->ppr->u.sr8.mcs[band][5] << 16)|(pi->ppr->u.sr8.mcs[band][4]);
...
BCMATTACHFN(wlc_phy_txpwr_srom12_read_ppr)(phy_info_t *pi)
{
	if (!(SROMREV(pi->sh->sromrev) < 12)) {
	    ...
	    /* --------------2G------------------- */
	    /* 2G CCK */
	    pi->ppr->u.sr11.cck.bw20 = (uint16)PHY_GETINTVAR(pi, rstr_cckbw202gpo);
	    pi->ppr->u.sr11.cck.bw20in40 = (uint16)PHY_GETINTVAR(pi, rstr_cckbw20ul2gpo);

	    pi->ppr->u.sr11.offset_2g = (uint16)PHY_GETINTVAR(pi, rstr_ofdmlrbw202gpo);
	    /* 2G OFDM_20 */
	    nibble 		= pi->ppr->u.sr11.offset_2g & 0xf;
	    nibble01 	= (nibble<<4)|nibble;
	    nibble 		= (pi->ppr->u.sr11.offset_2g>>4)& 0xf;
	    ...
	    /* 2G MCS_20 */
	    pi->ppr->u.sr11.mcs_2g.bw20 = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw202gpo);
	    /* 2G MCS_40 */
	    pi->ppr->u.sr11.mcs_2g.bw40 = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw402gpo);

	    pi->ppr->u.sr11.offset_20in40_l = (uint16)PHY_GETINTVAR(pi, rstr_sb20in40lrpo);
	    pi->ppr->u.sr11.offset_20in40_h = (uint16)PHY_GETINTVAR(pi, rstr_sb20in40hrpo);

	    pi->ppr->u.sr11.offset_dup_h = (uint16)PHY_GETINTVAR(pi, rstr_dot11agduphrpo);
	    pi->ppr->u.sr11.offset_dup_l = (uint16)PHY_GETINTVAR(pi, rstr_dot11agduplrpo);

#ifdef BAND5
	    /* ---------------5G--------------- */
	    /* 5G 11agnac_20IN20 */
	    pi->ppr->u.sr11.ofdm_5g.bw20[0] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw205glpo);
	    pi->ppr->u.sr11.ofdm_5g.bw20[1] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw205gmpo);
	    pi->ppr->u.sr11.ofdm_5g.bw20[2] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw205ghpo);
	    pi->ppr->u.sr11.ofdm_5g.bw20[3] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw205gx1po);
	    pi->ppr->u.sr11.ofdm_5g.bw20[4] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw205gx2po);

	    pi->ppr->u.sr11.offset_5g[0]	= (uint16)PHY_GETINTVAR(pi, rstr_mcslr5glpo);
	    pi->ppr->u.sr11.offset_5g[1] = (uint16)PHY_GETINTVAR(pi, rstr_mcslr5gmpo);
	    pi->ppr->u.sr11.offset_5g[2] = (uint16)PHY_GETINTVAR(pi, rstr_mcslr5ghpo);
	    pi->ppr->u.sr11.offset_5g[3] = (uint16)PHY_GETINTVAR(pi, rstr_mcslr5gx1po);
	    pi->ppr->u.sr11.offset_5g[4] = (uint16)PHY_GETINTVAR(pi, rstr_mcslr5gx2po);

	    /* 5G 11nac 40IN40 */
	    pi->ppr->u.sr11.mcs_5g.bw40[0] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw405glpo);
	    pi->ppr->u.sr11.mcs_5g.bw40[1] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw405gmpo);

	    pi->ppr->u.sr11.mcs_5g.bw40[2] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw405ghpo);
	    pi->ppr->u.sr11.mcs_5g.bw40[3] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw405gx1po);
	    pi->ppr->u.sr11.mcs_5g.bw40[4] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw405gx2po);

	    /* 5G 11nac 80IN80 */
	    pi->ppr->u.sr11.mcs_5g.bw80[0] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw805glpo);
	    pi->ppr->u.sr11.mcs_5g.bw80[1] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw805gmpo);
	    pi->ppr->u.sr11.mcs_5g.bw80[2] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw805ghpo);
	    pi->ppr->u.sr11.mcs_5g.bw80[3] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw805gx1po);
	    pi->ppr->u.sr11.mcs_5g.bw80[4] = (uint32)PHY_GETINTVAR(pi, rstr_mcsbw805gx2po);
	    ...
	    pi->ppr->u.sr11.offset_40in80_l[0] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80lr5glpo);
	    pi->ppr->u.sr11.offset_40in80_h[0] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80hr5glpo);
	    pi->ppr->u.sr11.offset_40in80_l[1] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80lr5gmpo);
	    pi->ppr->u.sr11.offset_40in80_h[1] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80hr5gmpo);
	    pi->ppr->u.sr11.offset_40in80_l[2] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80lr5ghpo);
	    pi->ppr->u.sr11.offset_40in80_h[2] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80hr5ghpo);
	    pi->ppr->u.sr11.offset_40in80_l[3] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80lr5gx1po);
	    pi->ppr->u.sr11.offset_40in80_h[3] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80hr5gx1po);
	    pi->ppr->u.sr11.offset_40in80_l[4] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80lr5gx2po);
	    pi->ppr->u.sr11.offset_40in80_h[4] = (uint16)PHY_GETINTVAR(pi, rstr_sb40and80hr5gx2po);
#endif /* BAND5G */
	}
}
...
static const char BCMATTACHDATA(rstr_pdoffset5gsubbanda0)[] = "pdoffset5gsubbanda0";
...
static const char BCMATTACHDATA(rstr_pdoffset5gsubbanda1)[] = "pdoffset5gsubbanda1";
	...
	uint8 param, uint8 band, uint8 offset,  const char * name)
{
	pwrdet->pwrdet_a1[param][band] =
		(int16)PHY_GETINTVAR_ARRAY(pi, name, offset);
	offset++;
	...
	uint8 subband, bool update_rsdb_core1_params, uint8 ant)
{
	...
	/* CORE 0 */
	pwrdet->max_pwr[0][b] = (int8)PHY_GETINTVAR_ARRAY(pi, rstr_maxp5ga0, subband);
	wlc_phy_txpwr_srom11_read_pwrdet(pi, pwrdet, 0, b, b_triple_offset, rstr_pa5ga0);
	pwrdet->tssifloor[0][b] = (int16)PHY_GETINTVAR_ARRAY(pi, rstr_tssifloor5g, subband);

	/* CORE 1 no reuse */
	if ((PHYCORENUM(pi->pubpi->phy_corenum) > 1) ||
		(update_rsdb_core1_params == TRUE)) {
		pwrdet->max_pwr[ant][b] = (int8)PHY_GETINTVAR_ARRAY(pi, rstr_maxp5ga1, subband);
	}
	/* CORE 1 or reuse */
	if ((PHYCORENUM(pi->pubpi->phy_corenum) > 1) ||
	...
	/* CORE 2 no reuse */
	if (PHYCORENUM(pi->pubpi->phy_corenum) > 2) {
		pwrdet->max_pwr[2][b] = (int8)PHY_GETINTVAR_ARRAY(pi, rstr_maxp5ga2, subband);
	}
	/* CORE 2 or reuse */
	if (PHYCORENUM(pi->pubpi->phy_corenum) > 2 ||
		(pi->u.pi_acphy->srom_tworangetssi5g && ACMAJORREV_2(pi->pubpi->phy_rev))) {
...
BCMATTACHFN(wlc_phy_txpwr_srom11_read)(phy_info_t *pi)
{
	...
	/* 2G band */
	pwrdet->max_pwr[0][0] = (int8)PHY_GETINTVAR(pi, rstr_maxp2ga0);
	wlc_phy_txpwr_srom11_read_pwrdet(pi, pwrdet, 0, 0, 0, rstr_pa2ga0);
	pwrdet->tssifloor[0][0] = (int16)PHY_GETINTVAR_ARRAY(pi, rstr_tssifloor2g, 0);
#ifdef POWPERCHANNL
	...
	if ((PHYCORENUM(pi->pubpi->phy_corenum) > 1) ||
		(update_rsdb_core1_params == TRUE)) {
		pwrdet->max_pwr[ant][0]	= (int8)PHY_GETINTVAR(pi, rstr_maxp2ga1);
#ifdef POWPERCHANNL
		pwrdet->max_pwr_SROM2G[ant] = (int8)PHY_GETINTVAR(pi, rstr_maxp2ga1);
		for (ch = 0; ch < CH20MHz_NUM_2G; ch++) {
			pwrdet->PwrOffsets2GNormTemp[ant][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTNA1, ch, 0);
			pwrdet->PwrOffsets2GLowTemp[ant][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTLA1, ch, 0);
			pwrdet->PwrOffsets2GHighTemp[ant][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTHA1, ch, 0);
	...
	if (PHYCORENUM(pi->pubpi->phy_corenum) > 2) {
		pwrdet->max_pwr[2][0] = (int8)PHY_GETINTVAR(pi, rstr_maxp2ga2);
#ifdef POWPERCHANNL
		pwrdet->max_pwr_SROM2G[2] =
			(int8)PHY_GETINTVAR(pi, rstr_maxp2ga2);
		for (ch = 0; ch < CH20MHz_NUM_2G; ch++) {
			pwrdet->PwrOffsets2GNormTemp[2][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTNA2, ch, 0);
			pwrdet->PwrOffsets2GLowTemp[2][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTLA2, ch, 0);
			pwrdet->PwrOffsets2GHighTemp[2][ch] =
				(int8)PHY_GETINTVAR_ARRAY_DEFAULT(pi, rstr_PowOffs2GTHA2, ch, 0);
		}
	...
	pwrdet->pdoffset5gsubband[0] = (uint16)PHY_GETINTVAR(pi, rstr_pdoffset5gsubbanda0);
	...
	if ((PHYCORENUM(pi->pubpi->phy_corenum) > 1) ||
		...
		pwrdet->pdoffset5gsubband[ant] =
			(uint16)PHY_GETINTVAR(pi, rstr_pdoffset5gsubbanda1);
...
BCMATTACHFN(wlc_phy_txpwr_srom12_read)(phy_info_t *pi)
{
	...
	if (!(SROMREV(pi->sh->sromrev) < 12)) {
		...
		pwrdet->pdoffset20in40[core][0] = PDOFFSET(pi, rstr_pdoffset20in40m5gb0, core);
		pwrdet->pdoffset20in40[core][1] = PDOFFSET(pi, rstr_pdoffset20in40m5gb1, core);
		pwrdet->pdoffset20in40[core][2] = PDOFFSET(pi, rstr_pdoffset20in40m5gb2, core);
		pwrdet->pdoffset20in40[core][3] = PDOFFSET(pi, rstr_pdoffset20in40m5gb3, core);
		pwrdet->pdoffset20in40[core][4] = PDOFFSET(pi, rstr_pdoffset20in40m5gb4, core);
		pwrdet->pdoffset20in80[core][0] = PDOFFSET(pi, rstr_pdoffset20in80m5gb0, core);
		pwrdet->pdoffset20in80[core][1] = PDOFFSET(pi, rstr_pdoffset20in80m5gb1, core);
		pwrdet->pdoffset20in80[core][2] = PDOFFSET(pi, rstr_pdoffset20in80m5gb2, core);
		pwrdet->pdoffset20in80[core][3] = PDOFFSET(pi, rstr_pdoffset20in80m5gb3, core);
		pwrdet->pdoffset20in80[core][4] = PDOFFSET(pi, rstr_pdoffset20in80m5gb4, core);
		pwrdet->pdoffset40in80[core][0] = PDOFFSET(pi, rstr_pdoffset40in80m5gb0, core);
		pwrdet->pdoffset40in80[core][1] = PDOFFSET(pi, rstr_pdoffset40in80m5gb1, core);
		pwrdet->pdoffset40in80[core][2] = PDOFFSET(pi, rstr_pdoffset40in80m5gb2, core);
		pwrdet->pdoffset40in80[core][3] = PDOFFSET(pi, rstr_pdoffset40in80m5gb3, core);
		pwrdet->pdoffset40in80[core][4] = PDOFFSET(pi, rstr_pdoffset40in80m5gb4, core);
	    }
...
wlc_phy_tof_kvalue(wlc_phy_t *ppi, chanspec_t chanspec, uint32 *kip, uint32 *ktp, uint8 seq_en)
{
	...
	ASSERT(pi != NULL);
	if (ISACPHY(pi))
		return wlc_phy_tof_kvalue_acphy(pi, chanspec, RSPEC_ENCODE_VHT, kip, ktp, seq_en);
...
/* Get TOF K value for initiator and target */
int
wlc_phy_kvalue(wlc_phy_t *ppi, chanspec_t chanspec, ratespec_t rspec, uint32 *kip,
	uint32 *ktp, uint8 seq_en)
{
	...
	ASSERT(pi != NULL);
	if (ISACPHY(pi))
		return wlc_phy_tof_kvalue_acphy(pi, chanspec, rspec, kip, ktp, seq_en);
