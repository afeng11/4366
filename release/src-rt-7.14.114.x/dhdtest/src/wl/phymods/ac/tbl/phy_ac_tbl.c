...
WLBANDINITFN(wlc_phy_edcrs_thresh_acphy)(phy_info_t *pi)
{
	...
	if (ACREV_GE(pi->pubpi->phy_rev, 32)) {
		...
		WRITE_PHYREG(pi, ed_crs20LAssertThresh00, assert);
		WRITE_PHYREG(pi, ed_crs20LAssertThresh10, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh00, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh10, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh00, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh10, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh00, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh10, assert);

		/* Set the EDCRS De-assert Threshold to -77dBm */
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh00, deassert);
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh10, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh00, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh10, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh00, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh10, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh00, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh10, deassert);

		/* Core1 */
		/* Set the EDCRS Assert Threshold to -71dBm */
		WRITE_PHYREG(pi, ed_crs20LAssertThresh01, assert);
		WRITE_PHYREG(pi, ed_crs20LAssertThresh11, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh01, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh11, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh01, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh11, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh01, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh11, assert);

		/* Set the EDCRS De-assert Threshold to -77dBm */
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh01, deassert);
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh11, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh01, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh11, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh01, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh11, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh01, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh11, deassert);

		/* Core2 */
		/* Set the EDCRS Assert Threshold to -71dBm */
		WRITE_PHYREG(pi, ed_crs20LAssertThresh02, assert);
		WRITE_PHYREG(pi, ed_crs20LAssertThresh12, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh02, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh12, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh02, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh12, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh02, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh12, assert);

		/* Set the EDCRS De-assert Threshold to -77dBm */
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh02, deassert);
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh12, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh02, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh12, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh02, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh12, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh02, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh12, deassert);

		/* Core3 */
		/* Set the EDCRS Assert Threshold to -71dBm */
		WRITE_PHYREG(pi, ed_crs20LAssertThresh03, assert);
		WRITE_PHYREG(pi, ed_crs20LAssertThresh13, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh03, assert);
		WRITE_PHYREG(pi, ed_crs20UAssertThresh13, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh03, assert);
		WRITE_PHYREG(pi, ed_crs20Lsub1AssertThresh13, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh03, assert);
		WRITE_PHYREG(pi, ed_crs20Usub1AssertThresh13, assert);

		/* Set the EDCRS De-assert Threshold to -77dBm */
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh03, deassert);
		WRITE_PHYREG(pi, ed_crs20LDeassertThresh13, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh03, deassert);
		WRITE_PHYREG(pi, ed_crs20UDeassertThresh13, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh03, deassert);
		WRITE_PHYREG(pi, ed_crs20Lsub1DeassertThresh13, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh03, deassert);
		WRITE_PHYREG(pi, ed_crs20Usub1DeassertThresh13, deassert);
	} else {
		/* Set the EDCRS Assert Threshold to -71dBm */
...
/** Return True if PHY is capable of 80p80 and 160. Currently returns 1 for ACPHY 4349A0 */
static bool wlc_phy_ac_160_capable(phy_info_t *pi)
{
	return (ACMAJORREV_4(pi->pubpi->phy_rev)) ? TRUE: FALSE;
}
...
wlc_phy_ac_caps(phy_info_t *pi)
{
	...
	cap |= wlc_phy_ac_160_capable(pi) ? (PHY_CAP_160MHZ | PHY_CAP_8080MHZ): 0;
                          ...
                          const void *data)
{
	...
	if ((id == ACPHY_TBL_ID_RFSEQBUNDLE) && ((offset & 0xf) > pi_ac->tof_rfseq_bundle_offset))
		pi_ac->tof_rfseq_bundle_offset = (uint16)(offset & 0xf);
