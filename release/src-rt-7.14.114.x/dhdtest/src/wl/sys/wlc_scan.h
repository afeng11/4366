 ...
 *
 * $Id: wlc_scan.h 524101 2015-01-06 00:46:21Z $
 */
...
extern wlc_bsscfg_t *wlc_scanmac_get_bsscfg(wlc_scan_info_t *scan, int macreq);
struct ether_addr *wlc_scanmac_get_mac(wlc_scan_info_t *scan, int macreq);
