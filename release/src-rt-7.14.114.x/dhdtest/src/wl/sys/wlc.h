 ...
 *
 * $Id: wlc.h 530263 2015-01-29 18:21:14Z $
 */
...
#define	WL_HWRXOFF			40 	/* chip rx buffer offset */
...
#if D11CONF_GE(64)
#define TXFID_QUEUE_MASK		(TXFID_QUEUE_LOW_MASK | TXFID_QUEUE_HIGH_MASK)
#define TXFID_QUEUE_LOW_MASK		0x0007 /* Bits 0-2 */
#define TXFID_QUEUE_HIGH_MASK		0x6000 /* Bits 13-14 */
#define TXFID_QUEUE_HIGH_SHIFT		10 /* shift 10 bits */
#define TXFID_SEQ_MASK		0x1FE0 /* Bits 5-12 */
#else
...
#if D11CONF_GE(64)
#define WLC_TXFID_GET_QUEUE(frameID) \
	(((frameID) & TXFID_QUEUE_LOW_MASK) | \
	(((frameID) & TXFID_QUEUE_HIGH_MASK) >> TXFID_QUEUE_HIGH_SHIFT))
#define WLC_TXFID_SET_QUEUE(fifo) \
	(((fifo) & TXFID_QUEUE_LOW_MASK) | \
	(((fifo) << TXFID_QUEUE_HIGH_SHIFT) & TXFID_QUEUE_HIGH_MASK))
#else
...
extern void wlc_fragthresh_set(wlc_info_t *wlc, uint fifo, uint16 thresh);
...
void wlc_scb_set_auth(wlc_info_t *wlc, wlc_bsscfg_t *cfg, struct scb *scb,
	bool enable, uint32 flag, int rc);

/** process packets associated with the freeing scb */
void wlc_pktq_scb_free(wlc_info_t *wlc, struct pktq *pktq, struct scb *scb);
