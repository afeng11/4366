 ...
 *
 * $Id: wlc_csa.c 529145 2015-01-26 09:02:18Z $
 */
		...
		if (tag->len >= DOT11_EXT_CSA_IE_LEN) {
			...
			if (tag != NULL) {
				wide_bw_ie = (dot11_wide_bw_chan_switch_ie_t *)
					...
					DOT11_MNG_WIDE_BW_CHANNEL_SWITCH_ID, sizeof(*wide_bw_ie));
			}
