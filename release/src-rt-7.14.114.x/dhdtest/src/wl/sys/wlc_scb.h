 ...
 *
 * $Id: wlc_scb.h 527938 2015-01-20 19:43:17Z $
 */
...
void wlc_scb_bsscfg_scbclear(wlc_info_t *wlc, wlc_bsscfg_t *cfg, bool perm);
...
/* scb marking bitfield */
#define SCB_MARK_FOR_DELETION	(1 << 0)	/* mark to be deleted in watchdog */
#define SCB_DEL_IN_PROG		(1 << 1)	/* delete in progress - clip recursion */

/* scb marking bitfield helpers */
#define SCB_MARKED_FOR_DEL(a)	((a)->mark & SCB_MARK_FOR_DELETION)
#define SCB_MARK_FOR_DEL(a)	((a)->mark |= SCB_MARK_FOR_DELETION)
...
#define SCB_HT_PROP_RATES_CAP_SET(a) FALSE
#endif /* WL11N */
...
#define SCB_DEAUTH_PEND(_a)	(((_a)->flags3 & SCB3_DEAUTH_PEND) != 0)
#define SCB_DEAUTH_PEND_SET(_a)	((_a)->flags3 |= SCB3_DEAUTH_PEND)
#define SCB_DEAUTH_PEND_CLR(_a)	((_a)->flags3 &= ~SCB3_DEAUTH_PEND)
