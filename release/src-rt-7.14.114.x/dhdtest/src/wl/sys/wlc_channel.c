 ...
 *
 * $Id: wlc_channel.c 635239 2016-05-03 09:13:08Z $
 */
                          ...
                          char *mapped_ccode, uint *mapped_regrev)
{
	...
	const char *srom_ccode = wlc_cmi->cm->srom_ccode;
	uint srom_regrev = (uint8)wlc_cmi->cm->srom_regrev;
...
const struct {
	...
	{BCM94350X14, {{QDB(19)+2, QDB(19)+2, WLC_TXPWR_MAX, WLC_TXPWR_MAX}, /* 2g SAR limits */
	{{QDB(18), QDB(18), WLC_TXPWR_MAX, WLC_TXPWR_MAX}, /* 5g subband 0 SAR limits */
	{QDB(18), QDB(18), WLC_TXPWR_MAX, WLC_TXPWR_MAX}, /* 5g subband 1 SAR limits */
	{QDB(18), QDB(18), WLC_TXPWR_MAX, WLC_TXPWR_MAX}, /* 5g subband 2 SAR limits */
	{QDB(18), QDB(18), WLC_TXPWR_MAX, WLC_TXPWR_MAX}  /* 5g subband 3 SAR limits */
	}}},
};
...
wlc_channel_reg_limits(wlc_cm_info_t *wlc_cmi, chanspec_t chanspec, ppr_t *txpwr)
{
	...
	if ((WLC_LOCALE_PRIORITIZATION_2G_ENABLED(wlc) &&
		...
		!wlc_valid_chanspec_db(wlc_cmi, chanspec)) {
...
#if defined(BCMDBG) || defined(WLTDLS)
