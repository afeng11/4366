 ...
 *
 *
 * $Id: wlc_scb_ratesel.h 523117 2014-12-26 18:32:49Z $
 */
...
extern void wlc_scb_ratesel_upd_txstatus_normalack(wlc_ratesel_info_t *wrsi, struct scb *scb,
	...
	bool sgi, uint8 antselid, bool fbr);
...
extern void wlc_scb_ratesel_upd_txs_blockack(wlc_ratesel_info_t *wrsi, struct scb *scb,
	...
	uint8 mcs, bool sgi, uint8 antselid);
...
extern void wlc_scb_ratesel_upd_txs_ampdu(wlc_ratesel_info_t *wrsi, struct scb *scb, uint16 frameid,
	...
	bool tx_error, uint8 tx_mcs, bool sgi, uint8 antselid);
#endif /* WLAMPDU_MAC */
...
extern bool wlc_scb_ratesel_sync(wlc_ratesel_info_t *wrsi, struct scb *scb, uint fifo,
	uint now, int rssi);
#endif /* WL11N */
...
extern void wlc_scb_ratesel_rfbr(wlc_ratesel_info_t *wrsi, struct scb *scb, uint16 frameid);
