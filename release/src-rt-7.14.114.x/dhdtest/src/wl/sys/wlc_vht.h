 ...
 *
 * $Id: wlc_vht.h 523117 2014-12-26 18:32:49Z $
 */
...
#ifdef WL_MODESW
extern void wlc_vht_sync_bcn_opmode(wlc_vht_info_t *vhti, wlc_bsscfg_t *bsscfg, struct scb *scb,
chanspec_t max_opermode_chanspec);
#endif
...
extern void wlc_vht_upd_txbf_cap(wlc_vht_info_t *vhti, uint8 bfr, uint8 bfe);
