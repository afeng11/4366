 ...
 *
 * $Id: wlc_11d.c 528311 2015-01-22 00:18:20Z $
 */
...
#ifdef CNTRY_DEFAULT
	{"country_default", IOV_CNTRY_DEFAULT, (0), IOVT_BOOL, 0},
#endif /* CNTRY_DEFAULT */
#ifdef LOCALE_PRIORITIZATION_2G
	{"ccode_pr_2g", IOV_CCODE_PR_2G, (0), IOVT_BOOL, 0},
#endif /* LOCALE_PRIORITIZATION_2G */
#endif /* STA */
	{NULL, 0, 0, 0, 0}
};
	...
	void *params, uint p_len, void *arg, int len, int val_size, struct wlc_if *wlcif)
{
	...
	case IOV_SVAL(IOV_AUTOCOUNTRY): {
		...
		/* Make sure that only non AWDL bsscfg is associated */
...
wlc_11d_scan_complete(wlc_11d_info_t *m11d, int status)
{
	...
	wlc_11d_set_autocountry_scan_learned(wlc->m11d, best_country_abbrev);
