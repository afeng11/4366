 ...
 * $Id: km_hw_impl.h 523118 2014-12-26 18:53:31Z $
 */
...
#define KM_HW_AMT_MAX MAX(AMT_SIZE, RCMTA_SIZE)
#define KM_HW_IDX_MAX KM_HW_AMT_MAX

/* bitmap of amt/rcmta index */
typedef amt_idx_t amt_idx_bitmap_t[CEIL(KM_HW_AMT_MAX, NBBY)];
...
#define KM_HW_MAX_TKMIC_KEYS(_hw) KM_HW_KEYTAB_SUPPORTED(_hw) ? AMT_SIZE : \
	WSEC_MAX_TKMIC_ENGINE_KEYS
#define KM_HW_MAX_SMS4MIC_KEYS(_hw) KM_HW_KEYTAB_SUPPORTED(_hw) ? AMT_SIZE : \
	WSEC_MAX_SMS4MIC_ENGINE_KEYS
...
#define KM_HWKTAB_SMS4_MIC_KEY_ADDR(_hw, _idx) (KM_HWKTAB_SMS4_MIC_KEY_SIZE * (_idx))
#endif /* WL_HWKTAB */
