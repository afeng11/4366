 ...
 * $Id: km_bsscfg.c 523118 2014-12-26 18:53:31Z $
 */
...
km_bsscfg_get_amt_idx(keymgmt_t *km, const wlc_bsscfg_t *bsscfg)
{
	...
	if (PSTA_ENAB(KM_PUB(km))) {
		...
		km_hw_amt_reserve(km->hw, PSTA_TA_STRT_INDX, PSTA_RA_PRIM_INDX, FALSE);
		km_hw_amt_reserve(km->hw, PSTA_RA_PRIM_INDX, 1, FALSE);
	}
#endif /* PSTA */
