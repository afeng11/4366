 ...
 *
 * $Id: wlc_clm_data.h 529035 2015-01-25 06:41:19Z $
 */
...
#define CLM_FORMAT_VERSION_MAJOR 16
...
enum clm_data_flags {
	...
	CLM_DATA_FLAG_REG_SC_RULES_MASK = 0x47,

	/** Bits to remove from index byte to get linear index */
	CLM_DATA_FLAG_REG_SC_RULES_EXTRA_BITS = 0x38,
...
/** Subchannel rules' indices, as encoded in country flags */
typedef enum clm_data_scr_indices {
